...
public class FeathersClientConfig {
    ...
    public static final ModConfigSpec.ConfigValue<Boolean> REGEN_EFFECT;
    public static final ModConfigSpec.ConfigValue<Boolean> FROST_SOUND;
    public static final ModConfigSpec.ConfigValue<Boolean> DISPLAY_WEIGHTS;
    public static final ModConfigSpec.ConfigValue<Boolean> VISUAL_WEIGHTS;
    public static final ModConfigSpec.ConfigValue<Boolean> AFFECTED_BY_RIGHT_HEIGHT;
    public static final ModConfigSpec.ConfigValue<Boolean> FADE_WHEN_FULL;

    public static final ModConfigSpec.ConfigValue<Integer> X_OFFSET;
    public static final ModConfigSpec.ConfigValue<Integer> Y_OFFSET;

    public static final ModConfigSpec.ConfigValue<Integer> FADE_IN_COOLDOWN;
    public static final ModConfigSpec.ConfigValue<Integer> FADE_OUT_COOLDOWN;
    public static final ModConfigSpec.ConfigValue<Integer> FADE_COOLDOWN;
